...
- ACP agent-driven mode is separate from native sub-agents: `agent_drive` controls an existing persistent ACP-bound session and does not change sub-agent routing or lifecycle.
