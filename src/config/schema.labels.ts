...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "acp.drive": "ACP Agent Drive",
  "acp.drive.maxTurns": "ACP Drive Max Turns",
  "acp.drive.maxWallClockSec": "ACP Drive Max Duration (seconds)",
  "acp.drive.idleTimeoutSec": "ACP Drive Idle Timeout (seconds)",
  "acp.drive.redirectPrefix": "ACP Drive Redirect Prefix",
